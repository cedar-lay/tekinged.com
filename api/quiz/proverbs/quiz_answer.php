<?php
/*
 * api/quiz/proverbs/quiz_answer.php
 *
 ...
 *             quiz_answer.php call) — NOT the visible explanation text.
 *
 * "explanation" is always included (not just on wrong answers, unlike
 * Parts of Speech) — matches the original's getMessage(), which
 * always shows both the literal and figurative meaning.
 */
...
$response = [
    ...
    'word'                => $question->correctPal,
    'explanation'         => 'The literal meaning of "' . $question->correctPal . '" is "' . $question->correctEnglish . '".',
...
if ($status->remaining() > 0) {
    $nextQuestion = generate_proverb_question($mysqli, $status);
